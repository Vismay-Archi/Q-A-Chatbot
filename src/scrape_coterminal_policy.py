...
URL = "https://www.iit.edu/financial-aid/policies-and-procedures/accelerated-masters-program-student-policy"

headers = {
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36'
}

def scrape_coterminal_policy(url):
...
# Run scraper
print("Co-Terminal Policy Page Scraper")
print("="*50)

sections = scrape_coterminal_policy(URL)
...
# Save JSON
json_file = "iit_coterminal_policy.json"
